...
this.setState({
  ...
  searchdata(){
    ...
    let result=this.state.employeeList.filter(list=>
      list.firstName.toLowerCase().includes(this.state.searchText))
      console.log(result);
     this.setState({
      employeeList:result
    })
  ...
  rendertoDoList(){
    return(
        ...
        <div className="renderTodoList">
          ...
          <p>Search<span><input  name="searchText" onKeyUp={this.searchdata} onChange={this.updateSearchtext}></input></span> </p>
              ...
              {this.state.employeeList.map((value, index)=>{
                    return(
                      this.state.editIndex !== index ? <tr>
                            ...
                            }} className="btn btn-outline-primary">Edit</button></td>
                          ...
                          }} className="btn btn-outline-primary">Cancel</button></td>
                          <td className="centerAll" id={index+8}><button onClick={()=>{
                            this.updateEmployee(index)
                          }} className="btn btn-outline-info">Update</button></td>
                        </tr>
                    )
                  })}
              </tbody>
